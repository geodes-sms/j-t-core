...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchPre_Class():V"/>
		<constant value="__exec__"/>
		<constant value="Pre_Class"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyPre_Class(NTransientLink;):V"/>
		...
		<constant value="__matchPre_Class"/>
		...
		<constant value="c_pre"/>
		<constant value="NTransientLink;.addTargetElement(SJ):V"/>
		<constant value="NTransientLinkSet;.addLink2(NTransientLink;B):V"/>
		<constant value="8:5-10:3"/>
		<constant value="__applyPre_Class"/>
		<constant value="NTransientLink;"/>
		<constant value="NTransientLink;.getSourceElement(S):J"/>
		<constant value="NTransientLink;.getTargetElement(S):J"/>
		<constant value="MTpre__"/>
		<constant value="J.+(J):J"/>
		<constant value="MRefiningTrace!Element;.setProperty(SJB):V"/>
		<constant value="9:11-9:20"/>
		<constant value="9:21-9:22"/>
		<constant value="9:21-9:27"/>
		<constant value="9:11-9:27"/>
		<constant value="9:3-9:27"/>
		<constant value="link"/>
	</cp>
	<field name="1" type="2"/>
	<field name="3" type="4"/>
	...
	<operation name="121">
		...
		<linenumbertable>
			...
			<lne id="129" begin="13" end="13"/>
			<lne id="130" begin="13" end="14"/>
			<lne id="131" begin="12" end="15"/>
			<lne id="132" begin="9" end="18"/>
			<lne id="120" begin="8" end="19"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="117" begin="7" end="19"/>
			<lve slot="2" name="83" begin="3" end="19"/>
			<lve slot="0" name="26" begin="0" end="19"/>
			<lve slot="1" name="133" begin="0" end="19"/>
		</localvariabletable>
	</operation>
</asm>
