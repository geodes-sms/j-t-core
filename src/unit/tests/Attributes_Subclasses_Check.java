...
class Attributes_Subclasses_Check {
	...
	public void isSuccessVF2() throws Exception {
		...
		// Imports
		MetaModel OracleMM = new MetaModel("Oracle", "../Ramifier_New/Model/Attributes_Subclasses/OracleV5.ecore"); // Oracle
																													// MetaModel
		MetaModel Oracle_ramified = new MetaModel("OracleRoot",
				"../Ramifier_New/Model/Attributes_Subclasses/OracleV5_augmented.ecore"); // Ramified Oracle

		Model oracle = new Model("Oracle", "../Ramifier_New/Model/Attributes_Subclasses/OracleV5.xmi", OracleMM); // Dynamic
																													// Instance
																													// from
																													// Oracle

		Pattern pre_A = new Pattern("pre_A",
				"../Ramifier_New/Model/Attributes_Subclasses/Attributes_Subclasses_Check.xmi", Oracle_ramified);
