...
class MatcherConstraintAttribute {
	...
	public void isSuccess() throws Exception {
		...
		Pattern ConstraintAttribute_pre = new Pattern("ConstraintAttribute_pre",
				"../Ramifier_New/Model/SingleMatch_pre.xmi", Oracle_ramified); // precondition
		Pattern Oracle_NAC = new Pattern("assignTables_NAC", "../Ramifier_New/Model/ConstraintAttribute_pre.xmi",
				Oracle_ramified); // NAC
